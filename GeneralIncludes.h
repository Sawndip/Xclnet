...
#define SYN_DYN_AMPA_DELAY (0.001) /*LIF_DT*/

// Stimulation of subpopulation /* using secs despite inconsistency with other parameter units */
#define STIM_ON (0.)
#define STIM_OFF (0.)
#define J_STIM (13.) /*J_STIM is now additive on top of J_EXT*/ /*(24.55)*/ /*24.55mV approx 50Hz, 34.8mV approx 100Hz*/
...
#define J_EXT (15) /*(11.046)*/ /*(15.315)*/ /*(11.046)*/ /*(11.45) new in-vivo*/ /*(11.046) new in-vitro*/ /*(7.07)*/ /*(6.966) in-vivo*/ /*(7.07) 1hz in-vitro*/
...
#define SYN_GAMMA_P (20000) /*(725.085)*/
#define SYN_GAMMA_D (500) /*(331.909)*/
#define SYN_THETA_P (2.) /*(1.3)*/
#define SYN_THETA_D (1.0)
#define SYN_SIGMA (3.35) /*(3.35)*/ /*3.35;*/ /*TODO: switch synapse noise back on*/
#define SYN_TAU (300) /*(346.3615)*/
#define SYN_TAU_CA (0.020) /*(0.0226936)*/
#define SYN_C_PRE (0.45) /*(0.56175)*/ /*(0.33705)*/ /*(0.56175)*/ /*(0.5617539)*/
#define SYN_C_POST (0.45) /*(1.23964)*/ /*(0.74378)*/ /*(1.23964)*/
...
#define SYN_DYN_TAU_NMDA_RISE (0.0050)
#define SYN_DYN_TAU_GABA_RISE (0.0005)
