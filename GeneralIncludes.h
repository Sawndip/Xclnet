...
#define MAX_TIME_STEPS (30) /*(12000000)*/ /*(12000000)*/ /*(300000)*/ /*no of timesteps, each of size dt*/
...
#define LIF_RM (20.0)
#define LIF_SIGMA (5)
#define LIF_REFRAC_TIME_EXC (0) /*200*/ /*timesteps*/
#define LIF_REFRAC_TIME_INH (0) /*200*/ /*timesteps*/
